...
SRC				=	$(SRC_DIR)parse_arg.c $(SRC_DIR)parse_color.c $(SRC_DIR)parse_map.c $(SRC_DIR)stock_file.c $(SRC_DIR)error.c $(SRC_DIR)utils.c $(SRC_DIR)main.c $(SRC_DIR)parse_color_01.c $(SRC_DIR)print_list.c $(SRC_DIR)init_data.c	\
